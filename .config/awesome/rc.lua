...
--
    ...
    -- F keys
     -- My Bindings
     awful.key({modkey }, "F1", function () awful.util.spawn_with_shell("librewolf") end),
     awful.key({modkey }, "F2", function () awful.util.spawn_with_shell("thunar") end),
     awful.key({ modkey }, "F3", function () awful.spawn("flatpak run eu.betterbird.Betterbird") end,
        {description = "launch Betterbird", group = "launcher"}),
     awful.key({ modkey }, "F4", function () awful.spawn("flatpak run im.riot.Riot") end,
